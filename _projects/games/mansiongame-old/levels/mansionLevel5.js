...
class MansionLevel5 {
  constructor(gameEnv) {
	...
	const path = this.path = gameEnv.path;
    this.width = width;
    this.height = height;
	...
	// Background data
	const image_background = path + "/images/projects/mansiongame-old/background_lvl5.png";
	...
	//data for player
	const sprite_player = path + "/images/projects/mansiongame-old/full_anims_spook.png";
